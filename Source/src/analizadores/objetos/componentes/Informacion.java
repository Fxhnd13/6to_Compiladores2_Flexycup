...
/**
 * clase que almacena la informacion de un lenguaje
 * @author jose_
 */
public class Informacion implements Serializable {
    ...
    /**
     * verifica si el dato enviado ya existe en esta instancia, y si no, agrega un error semantico, se realiza durante el analisis
     * @param dato dato a agregar
     * @param linea linea en la que se encuentra el dato
     * @param columna columna en la que se encuentra el dato
     * @param errores para agregar el error
     */
