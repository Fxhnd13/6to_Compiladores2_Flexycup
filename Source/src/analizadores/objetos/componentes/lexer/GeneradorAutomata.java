...
/**
 * Es la clase con los métodos para crear el automata que se guardará en el lenguaje genrado
 * @author jose_
 */
public class GeneradorAutomata {
    ...
    /**
     * agrega el nodo de final de cadena, (para identificar los estados que son finales)
     * y calcula los siguientes de cada nodo hoja
     */
    ...
    /**
     * metodo que genera todos los estados que tendrá el automata que se guardará en el lenguaje
     * generado
     */
    ...
    /**
     * asigna a los nodos hoja el tipo de token al que pertenecen
     * @param token token al que pertenecen
     * @param expresion arbol de expresion regular a evaluar
     */
    ...
    private int numerarNodosHoja(int id, Nodo expresion){
        if(expresion instanceof NodoConcat){
    ...
    private void calcularSiguientes(Nodo expresion){
        if(expresion instanceof NodoConcat){
    ...
    /**
     * crea el arbol generado para la expresion regular equivalente a un rango de caracteres
     * @param rango rango de caracteres
     * @param opcion si es de letras o numeros
     * @return el arbol generado
     */
    ...
    /**
     * crea el arbol de una cadena 
     * @param cadena cadena para la cual se generará el arbol
     * @return el nodo raiz del arbol generado
     */
