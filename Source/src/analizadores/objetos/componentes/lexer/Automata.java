...
/**
 * Clase que representa un Automata finito determinista, y que analiza una cadena  en la busqueda de tokens
 * @author jose_
 */
public class Automata implements Serializable {
    ...
    /**
     * Metodo que utiliza la cadena de entrada para analizar caracter a caracter y agrupar por tokens según la especificacion del lenguaje
     */
